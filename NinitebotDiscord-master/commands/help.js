...
exports.run = async (client, message, args) => {
    //Why is this code still here :O
    //if (${PREFIX}message.member.hasPermission("ADMINISTRATOR")) return message.author.send("__**MUSIC COMMANDS**__ \n${PREFIX}play, ${PREFIX}pause, ${PREFIX}resume, ${PREFIX}queue, ${PREFIX}search,${PREFIX}skip \n__**FUN COMMANDS**__ \n${PREFIX}meme, ${PREFIX}johnny, ${PREFIX}dan, ${PREFIX}quote, ${PREFIX}ping \n__**BASIC COMMANDS**__ \n${PREFIX}ninitebot, ${PREFIX}help", { code: 'md' });
    //if (message.author.send("__**ADMIN COMMANDS**__\n${PREFIX}purge <amount>, ${PREFIX}mimic <message>, ${PREFIX}help-mimic, ${PREFIX}volume\n__**MUSIC COMMANDS**__ \n${PREFIX}play, ${PREFIX}pause, ${PREFIX}resume, ${PREFIX}queue, ${PREFIX}search, ${PREFIX}volume, ${PREFIX}skip, ${PREFIX}fskip, \n__**FUN COMMANDS**__ \n${PREFIX}meme, ${PREFIX}johnny, ${PREFIX}dan, ${PREFIX}quote, ${PREFIX}ping \n__**BASIC COMMANDS**__ \n${PREFIX}ninitebot, ${PREFIX}help", { code: 'md' }));
